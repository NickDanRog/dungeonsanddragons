...
<!-- STRUCTURAL NOTE: Front matter for this document (introduction, how to use, formatting conventions, index/table of contents) has not yet been written. Add before finalizing the document. -->

---

# Asura Types

The creatures called "demons" by the people of the Nine Worlds are technically Asuras — outsiders born from divine mistakes, exiles from Hell who infiltrated the Nine Worlds during their construction. The goodness of the mortal populations rejected these entities, and the celestials responded by forming the Underworld as a prison. The asuras' lingering influence has plagued the worlds throughout their history, and the current crisis began when the ten heroes' attempt to sever the connection to the Underworld backfired, allowing demons to physically enter the worlds for the first time.

All asuras share the following racial traits unless otherwise noted in their individual entries:

**Asura Subtype Traits:**
- **Immunity** to curse effects, disease, and poison
- **Resistance** to acid 10 and electricity 10
- **Telepathy** 100 ft. (CR 5+)
- **Spell Resistance** equal to 11 + CR (CR 5+)
- **Regeneration** or **Fast Healing** (overcome by good weapons and good spells)
- **Damage Reduction** /cold iron or good (low CR) or /good (mid-high CR)
- **Elusive Aura (Su):** Asuras and their possessions are treated as though under the effects of a *nondetection* spell. The radius and DC scale with CR.
- **Spell-Like Abilities:** All asuras of CR 5+ have *greater teleport* (self plus 50 lbs. of objects only) at will. Most have a *summon* ability (1/day) that calls other asuras.
- **+6 racial bonus to Escape Artist, +4 racial bonus to Perception**
- **Bonus vs. Enchantment:** +2 racial bonus on saves against enchantment spells and effects

---

## SRD Asura Types

The following nine asura types are drawn from published Pathfinder 1st Edition sources. Stat blocks are reproduced from the SRD for reference during encounter design.
...
The most common asura encountered in the Nine Worlds. Tripurasuras are infiltrators and spies that assume humanoid forms to corrupt mortals and undermine faith. They manifest as tiny, muscular humanoids with frilled horn crowns and ruby-like glowing eyes. Each tripurasura has only one alternative form — it always appears as the same Small humanoid when shapechanged.
...
**SPECIAL ABILITIES**
**Change Shape (Su):** A tripurasura can assume only one alternative form — when it uses change shape, it always appears as the same Small humanoid. Most commonly gnomes or human children.
**Elusive (Su):** The creature and its carried items benefit from *nondetection* effects. A caster must succeed at a DC 14 caster level check to overcome this effect.
**Poison (Ex):** Sting — injury; Fort DC 12; frequency 1/round for 6 rounds; effect 1d2 Wisdom damage; cure 1 save.
...
*Source: Pathfinder RPG Bestiary 3*
...
**Init** +3; **Senses** darkvision 60 ft.; **Perception** +18; **Aura** elusive (30 ft.), mental static (30 ft., DC 18)
...
7 PE — *dispel magic* (3 PE), *id insinuation I* (2 PE, DC 16), *object reading* (1 PE), *scorching ray* (2 PE)
...
*Source: Pathfinder RPG Bestiary 5*
...
**XP** 3,200
LE Medium outsider (asura, evil, extraplanar, lawful)
**Init** +3; **Senses** all-around vision, darkvision 60 ft.; **Perception** +19; **Aura** elusive (30 ft.)
...
**SPECIAL ABILITIES**
**Dance of Disaster (Su):** Whenever an adhukait hits with a melee attack during a full-attack action, it can move 10 feet before making its next attack. The adhukait's normal speed does not limit this movement. This movement provokes attacks of opportunity as normal.
...
**XP** 6,400
LE Medium outsider (asura, evil, extraplanar, lawful)
**Init** +7; **Senses** all-around vision, darkvision 60 ft.; **Perception** +23; **Aura** elusive (50 ft.)
...
**BAB** +12; **CMB** +18 (+20 grapple); **CMD** 36 (38 vs. grapple)
...
**SPECIAL ABILITIES**
**Infused Weapons (Su):** Weapons an upasunda wields are considered to be magic for the purposes of overcoming damage reduction and count as both evil and lawful.
**Multiweapon Mastery (Ex):** An upasunda takes no penalties when fighting with multiple weapons.

**ECOLOGY**
**Environment** any (Hell)
**Organization** solitary, pair, or squad (3–6)
**Treasure** standard (masterwork longsword, masterwork spear, masterwork kukri, other treasure)
...
**Init** +3; **Senses** darkvision 60 ft., scent; **Perception** +19; **Aura** attraction (50 ft.), elusive (75 ft.)

**DEFENSE**
**AC** 23, touch 11, flat-footed 20 (+6 armor, +3 Dex, +6 natural, –2 size)
**hp** 161 (14d10+84); regeneration 5 (good weapons, good spells)
**Fort** +15, **Ref** +9, **Will** +11; +2 vs. enchantments
...
**BAB** +14; **CMB** +28 (+32 grapple); **CMD** 41 (can't be tripped)
...
**SPECIAL ABILITIES**
**Attraction Aura (Su):** An aghasura exudes a 50-foot aura whenever it remains motionless for at least 1 round. All nonevil creatures that enter this area must succeed at a DC 21 Will save or be compelled to move toward the aghasura's location. A creature that successfully saves is immune to the same aghasura's aura for 24 hours.
**Dual Wielder (Ex):** An aghasura does not take a penalty on attack or damage rolls when attacking with two weapons.
**Infused Weapons (Su):** Weapons an aghasura wields are considered magic for the purposes of overcoming damage reduction. In addition, such weapons gain the ability to deliver the aghasura's poison on a successful attack.
**Poison (Ex):** Bite or weapon — injury; Fort DC 23; frequency 1/round for 6 rounds; effect 1d4 Con damage; cure 2 consecutive saves.
...
**XP** 19,200
LE Medium outsider (asura, evil, extraplanar, lawful)
**Init** +7; **Senses** darkvision 60 ft., *see invisibility*; **Perception** +25; **Aura** elusive (75 ft.)

**DEFENSE**
**AC** 27, touch 17, flat-footed 20 (+7 Dex, +10 natural)
**hp** 147 (14d10+70); regeneration 5 (good spells, good weapons)
**Fort** +9, **Ref** +16, **Will** +13; +2 vs. enchantments
**DR** 10/good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 23
...
**Skills** Acrobatics +24 (+28 when jumping), Bluff +20, Climb +21, Escape Artist +23, Knowledge (planes) +12, Perception +25, Profession (soothsayer) +21, Sense Motive +21, Spellcraft +9, Stealth +24
**Languages** Common, Infernal; telepathy 100 ft.
**SQ** hateful prophecy, infernal arrows, selective nondetection

**SPECIAL ABILITIES**
**Dual Bows (Ex):** A japalisura can simultaneously wield two bows of any type. When it makes a full attack with both bows, the penalties for fighting with two weapons apply and can be offset with feats such as Two-Weapon Fighting. Extra attacks from sources like Manyshot or Rapid Shot apply to only one bow per round. A japalisura treats shortbows and composite shortbows as light weapons, and it treats other bows as one-handed weapons.
**Hateful Prophecy (Sp):** A japalisura can cast *augury* or *divination* for a willing creature, in which case the spell provides information that pertains to that creature's future rather than that of the asura. Upon completion, the japalisura attempts a Profession (soothsayer) check opposed by the creature's Sense Motive check. Success allows twisting the prophecy to convey impending violence or betrayal, subjecting the creature to *vengeful outrage* effects with an indicated enemy of the asura's choice. A DC 20 Will save resists this effect (save DC is Charisma-based).
**Infernal Arrows (Su):** As a swift action, a japalisura with at least one free hand can create 10 mundane arrows. It can have no more than 20 such arrows in existence at a time, and its arrows are always destroyed when fired, whether they hit their target or not.
**Selective Nondetection (Su):** A japalisura automatically succeeds at caster level checks to bypass its own elusive aura.
...
*Source: Pathfinder Adventure Path #136: Temple of the Peacock Spirit*
...
**DR** 10/good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 25
...
**BAB** +16; **CMB** +22 (+24 trip); **CMD** 40 (42 vs. trip)
**Feats** Combat Expertise, Combat Reflexes, Deflect Arrows, Dodge, Great Fortitude, Improved Initiative, Improved Trip, Mobility, Spring Attack
...
**SPECIAL ABILITIES**
**Pervert Miracle (Su):** As an immediate action, when a creature within 60 feet casts a divine spell that the nikaramsa can also use as a spell-like ability 3/day (bless, cure serious wounds, good hope, neutralize poison, remove blindness/deafness, remove curse, or remove disease) or casts a spell that would counter or remove one of those effects (bane, bestow curse, blindness/deafness, contagion, crushing despair, inflict serious wounds, or poison), the nikaramsa attempts an opposed Charisma check against the caster. Success converts the spell into its opposite effect against each original target.
**Savor Heresy (Su):** A nikaramsa gains a +2 profane bonus on attack rolls and a +5 profane bonus on damage rolls against creatures that have committed heresy or changed alignment within the last year. The asura's natural attacks ignore such creatures' damage reduction.
...
**XP** 51,200
LE Large outsider (asura, evil, extraplanar, lawful)
**Init** +7; **Senses** darkvision 60 ft., scent, scent of carnage, smoke sight; **Perception** +29; **Aura** elusive (75 ft.)

**DEFENSE**
**AC** 30, touch 12, flat-footed 27 (+3 Dex, +18 natural, –1 size)
**hp** 207 (18d10+108); regeneration 10 (good spells, good weapons)
**Fort** +17, **Ref** +11, **Will** +15; +2 vs. enchantments
...
**SPECIAL ABILITIES**
**Destructive Blades (Su):** A hishandura's melee attacks ignore hardness of less than 20 and damage reduction (except for DR/epic). When making full attacks against objects or structures, damage is doubled.
**Punitive Penance (Su):** Upon a successful rend, the target must succeed at a DC 25 Will save or experience overwhelming grief as per *terrible remorse*. Save DC is Charisma-based.
**Repentant Rain (Su):** Once per round after confirming a critical hit with a melee weapon, a hishandura can spray gore in a 30-foot cone. Non-asuras in the area are blinded for 1d3 rounds (DC 26 Reflex save negates). Blindness can be removed by wiping gore away (a move action), water immersion, or similar effects. Save DC is Strength-based.
**Scent of Carnage (Ex):** A hishandura's sense of smell is especially sensitive to blood and fresh injuries. It gains blindsense 60 ft. limited to corpses, heavily wounded creatures (at or below half hp), creatures with bleed damage, or those affected by repentant rain.
**Smoke Sight (Ex):** A hishandura can see through fire, fog, and smoke as if they were perfectly clear, ignoring the miss chance, up to normal vision range.
...
**XP** 307,200
LE Huge outsider (asura, evil, extraplanar, lawful)
**Init** +12; **Senses** all-around vision, darkvision 60 ft., low-light vision, scent, *true seeing*; **Perception** +34; **Aura** dimensional lock (20 ft., enemies only), elusive (100 ft.)
...
**Space** 15 ft.; **Reach** 15 ft.
**Special Attacks** curse of false wisdom, spirit blades (+27, 3d6+7/19–20), swallow whole (4d6+19 bludgeoning plus 4d8+12 acid, AC 15, 34 hp)
...
**Spirit Blades (Su):** As a swift action, an asurendra can call forth up to six longsword-shaped force effects that float near it until directed. The asurendra directs blades using a standard action (one blade) or full-attack action (all blades). Once directed, blades attack that target each round on the asurendra's turn until redirected or the target moves beyond 50 feet. Blades use the asurendra's BAB modified by its Wisdom modifier and deal 3d6 force damage plus Wisdom modifier (3d6+7). Only *disintegrate*, a *sphere of annihilation*, or a *rod of cancellation* (touch AC 25) can destroy a spirit blade. Blades vanish if their target dies, moves beyond 50 feet without retargeting, or the blade itself exceeds 50 feet from the asurendra.

**Asurendra Variants:**
- **Death Variant:** Replaces quickened *baleful polymorph* with quickened *slay living* and quickened *blade barrier* with quickened *circle of death*. Spirit blades deal negative energy damage instead of force damage, healing allied undead.
- **Sacrilege Variant:** Lacks spirit blades; gains *miracle* as a 1/day spell-like ability.
- **Shaping Variant:** Lacks spirit blades; gains Create Asura ability — as a full-round action, can turn a creature it has consumed within the last 24 hours into a tripurasura. Can combine consumed tripurasuras to create other asuras by total HD consumed. Cannot create other asurendras.
...
The following eight asura types were designed for the Rainbow Road campaign to fill CR gaps in the published roster. Combined with the nine SRD types above, they provide continuous coverage from CR 1 through CR 20. Design notes and nicknames are maintained in `rainbow-road_org-notes.md` under THE UNDERWORLD section.
...
The lowest-tier combat asura. Phankhonvrani are fast, wiry creatures with mottled gray skin and pronounced hunchbacks. One arm ends in a short, wickedly curved blade that appears grafted to the bone; the other arm is withered and nearly useless. They hunt in packs, using imperfect sound mimicry to lure victims into ambush positions. When three or more gather, their overlapping cries create a disorienting cacophony that unnerves even seasoned warriors.

**Phankhonvrani — CR 1**
**XP** 400
LE Small outsider (asura, evil, extraplanar, lawful)
**Init** +6; **Senses** darkvision 60 ft.; **Perception** +9

**DEFENSE**
**AC** 15, touch 13, flat-footed 13 (+2 Dex, +2 natural, +1 size)
**hp** 13 (2d10+2); fast healing 1
**Fort** +4, **Ref** +5, **Will** +1; +2 vs. enchantments
**DR** 2/cold iron or good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10

**OFFENSE**
**Speed** 40 ft.
**Melee** blade arm +5 (1d6+1/19–20), bite +0 (1d4)
**Space** 5 ft.; **Reach** 5 ft.

**STATISTICS**
**Str** 12, **Dex** 15, **Con** 13, **Int** 8, **Wis** 12, **Cha** 9
**BAB** +2; **CMB** +2; **CMD** 14
**Feats** Improved Initiative
**Skills** Acrobatics +7, Bluff +4, Escape Artist +13, Perception +9, Stealth +11
**Languages** Infernal

**SPECIAL ABILITIES**
**Distress Mimicry (Su):** As a standard action, a phankhonvrani can imperfectly mimic non-speech sounds — a child crying, a wounded animal, creaking timbers, breaking glass. A creature that hears the sound can attempt a Sense Motive check (DC 12) to recognize the mimicry as false. The DC is Charisma-based. The phankhonvrani cannot replicate speech or complex musical patterns.
**Cacophony (Su):** When three or more phankhonvrani are within 30 ft. of each other, their combined distress mimicry creates an overlapping chorus of discordant calls. All non-asura creatures within 30 ft. must succeed at a Will save (DC 12) or be shaken for 1d4 rounds. A creature that successfully saves is immune to that group's cacophony for 24 hours. The DC is Charisma-based and includes a +2 racial bonus.

**ECOLOGY**
**Environment** any (Hell or Nine Worlds)
**Organization** solitary, pair, pack (3–8), or swarm (9–20)
**Treasure** none

---

### Hatyararata
*CR 3 — Small — "Nightclaw"*

Wingless, imp-like assassins with soot-black skin and oversized hands tipped in razor claws. Hatyararata are ambush specialists that create illusory duplicates of themselves to flank opponents, strike with venomous precision, then reposition before retaliation. They are cunning and patient, preferring to observe targets for hours before committing to an attack. Their kills are precise and economical — a hallmark of asura contempt for mortal resilience.

**Hatyararata — CR 3**
**XP** 800
LE Small outsider (asura, evil, extraplanar, lawful)
**Init** +7; **Senses** darkvision 60 ft., *see invisibility*; **Perception** +11
...
**Melee** 2 claws +8 (1d4+1 plus poison)
**Special Attacks** shadow double, sneak attack +2d6
...
**STATISTICS**
**Str** 12, **Dex** 17, **Con** 14, **Int** 13, **Wis** 14, **Cha** 13
**BAB** +4; **CMB** +4; **CMD** 17
**Feats** Improved Initiative, Weapon Finesse
**Skills** Acrobatics +10, Bluff +8, Climb +16, Escape Artist +16, Perception +11, Sleight of Hand +10, Stealth +14
**Languages** Common, Infernal

**SPECIAL ABILITIES**
**Shadow Double (Su):** As a swift action, a hatyararata can create an illusory duplicate of itself in any square adjacent to its target. The duplicate is not a creature — it cannot attack, take damage, or be targeted by effects that require a creature. However, it is treated as an ally for the purpose of flanking. Any successful attack roll directed at the duplicate's square automatically dispels it (AC 10). The duplicate lasts until dispelled, until the hatyararata creates a new one, or for 1 minute. A hatyararata can maintain only one shadow double at a time.
**Poison (Ex):** Claws — injury; Fort DC 14; frequency 1/round for 4 rounds; effect 1d2 Dexterity damage; cure 1 save. The save DC is Constitution-based.
...
A sickly, thin humanoid with jaundiced skin stretched taut over visible bones, a perpetually drooling mouth, and two additional appendages sprouting from its torso — flexible, segmented stingers that drip a translucent venom. Aakarshaki are lure-and-control specialists. Their soothing, wordless call draws the unwary close, where the stingers do their quiet work. They are patient hunters that prefer isolated targets and rarely engage in direct combat unless cornered. Their intelligence makes them effective forward agents, sent ahead of raiding groups to neutralize sentries and scouts.
...
**Fort** +6, **Ref** +4, **Will** +7; +2 vs. enchantments
**DR** 5/cold iron or good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10

**OFFENSE**
**Speed** 30 ft.
**Melee** 2 stingers +8 (1d6+1 plus poison), slam +8 (1d4+1)
**Special Attacks** soothing call
**Spell-Like Abilities** (CL 6th; concentration +10)
At will — *daze* (DC 14), *lullaby* (DC 14)
3/day — *charm person* (DC 15), *hold person* (DC 16), *suggestion* (DC 17)
1/day — summon (level 3, 1d4 phankhonvrani 40%)

**STATISTICS**
**Str** 12, **Dex** 14, **Con** 13, **Int** 15, **Wis** 16, **Cha** 18
**BAB** +6; **CMB** +7; **CMD** 19
**Feats** Ability Focus (soothing call), Combat Reflexes, Weapon Finesse
**Skills** Bluff +13, Diplomacy +13, Escape Artist +17, Intimidate +10, Knowledge (local) +11, Perception +13, Perform (sing) +13, Sense Motive +12, Stealth +11
**Languages** Common, Infernal; telepathy 30 ft.

**SPECIAL ABILITIES**
**Soothing Call (Su):** As a standard action, an aakarshaki can emit a wordless, melodic hum that affects all non-asura creatures within 60 ft. that can hear it. Targets must succeed at a Will save (DC 19) or be fascinated for as long as the aakarshaki continues humming (a standard action each round). A fascinated creature that is attacked or shaken by an ally is freed from the effect. This is a sonic, mind-affecting, compulsion effect. The save DC is Charisma-based and includes a +2 bonus from Ability Focus.
**Poison (Ex):** Stinger — injury; Fort DC 14; frequency 1/round for 6 rounds; effect 1d3 Wisdom damage; cure 2 consecutive saves. The save DC is Constitution-based.
...
**Fort** +9, **Ref** +5, **Will** +8; +2 vs. enchantments
**DR** 5/cold iron or good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 17

**OFFENSE**
**Speed** 30 ft., climb 30 ft.
**Melee** 2 slams +14 (2d6+6), gore +14 (1d6+6)
**Special Attacks** rend (2 slams, 2d6+9)
**Spell-Like Abilities** (CL 6th; concentration +8)
At will — *greater teleport* (self plus 50 lbs. of objects only)
1/day — summon (level 4, 1d3 hatyararata 35%)

**STATISTICS**
**Str** 22, **Dex** 16, **Con** 17, **Int** 11, **Wis** 14, **Cha** 15
**BAB** +8; **CMB** +14 (+16 bull rush); **CMD** 27 (29 vs. bull rush)
**Feats** Improved Bull Rush, Power Attack, Skill Focus (Stealth), Weapon Focus (slam)
**Skills** Acrobatics +14, Climb +25, Escape Artist +20, Intimidate +13, Perception +17, Stealth +17, Survival +10
**Languages** Infernal; telepathy 100 ft.

**SPECIAL ABILITIES**
**Insignificance (Su):** A janavariseng radiates a passive aura that causes observers' attention to slide away from it. Any creature more than 5 ft. away must succeed at a Perception check (DC 20) to notice the janavariseng before it attacks; otherwise, the creature is treated as flat-footed against the janavariseng's first attack. This effect functions as *nondetection* against casual observation — it does not provide invisibility, and a creature that specifically searches for threats can attempt the Perception check as a move action. Once a janavariseng deals damage to or takes damage from a creature, that creature is immune to that janavariseng's insignificance for 24 hours. This is a mind-affecting effect. True seeing negates it. The DC is Charisma-based and includes a +6 racial bonus.
...
**hp** 95 (10d10+40); regeneration 5 (good weapons, good spells)
**Fort** +11, **Ref** +9, **Will** +6; +2 vs. enchantments
**DR** 5/good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 19

**OFFENSE**
**Speed** 20 ft., fly 60 ft. (good)
**Melee** 2 talons +15 (1d8+6), sting +15 (1d8+6 plus poison), bite +10 (1d6+3)
**Space** 10 ft.; **Reach** 5 ft. (10 ft. with sting)
**Special Attacks** diving strike, pinning gaze
**Spell-Like Abilities** (CL 8th; concentration +11)
Constant — *see invisibility*
At will — *greater teleport* (self plus 50 lbs. of objects only)
3/day — *dimension door*, *fear* (DC 17)
1/day — summon (level 5, 1 janavariseng or 1d3 aakarshaki 40%)

**STATISTICS**
**Str** 22, **Dex** 15, **Con** 18, **Int** 14, **Wis** 16, **Cha** 17
**BAB** +10; **CMB** +17; **CMD** 30
**Feats** Dodge, Flyby Attack, Improved Initiative, Mobility, Weapon Focus (sting)
**Skills** Acrobatics +12, Bluff +16, Escape Artist +21, Fly +17, Intimidate +16, Knowledge (planes) +12, Perception +20, Sense Motive +16, Stealth +11, Survival +13
**Languages** Common, Infernal; telepathy 100 ft.
...
### Khalahathi
*CR 10 — Large — "Widowmaker"*

A towering, black-skinned humanoid with four double-jointed arms and two faces — one on each side of its head — covered in expressionless silver masks that never change. The double-jointed arms bend in directions that defy anatomy, allowing the khalahathi to attack in any direction without turning. Most wield pairs of two-handed weapons — typically greatswords or greataxes — spinning them in overlapping arcs that create a killing field around their body. They are eerily silent fighters; the only sound during combat is the whistle of their weapons and the ring of metal on metal. Khalahathi serve as elite garrison guards and executioners in asura-held territories.

**Khalahathi — CR 10**
**XP** 9,600
LE Large outsider (asura, evil, extraplanar, lawful)
**Init** +5; **Senses** all-around vision, darkvision 60 ft., *true seeing*; **Perception** +23

**DEFENSE**
**AC** 25, touch 11, flat-footed 23 (+1 Dex, +1 dodge, +14 natural, –1 size)
**hp** 126 (12d10+60); regeneration 5 (good weapons, good spells)
**Fort** +13, **Ref** +5, **Will** +12; +2 vs. enchantments
**Defensive Abilities** all-around vision; **DR** 10/good; **Immune** curse effects, disease, flanking, poison; **Resist** acid 10, electricity 10; **SR** 21

**OFFENSE**
**Speed** 30 ft.
**Melee** 2 greatswords +19/+14 (2d6+10/19–20), 2 greataxes +19 (1d12+10/×3)
**Space** 10 ft.; **Reach** 10 ft.
**Special Attacks** whirlwind of steel
**Spell-Like Abilities** (CL 10th; concentration +13)
Constant — *true seeing*
At will — *greater teleport* (self plus 50 lbs. of objects only)
3/day — *mirror image*, *displacement*
1/day — summon (level 6, 1 mautchidaya or 1d3 janavariseng 45%)

**STATISTICS**
**Str** 24, **Dex** 13, **Con** 20, **Int** 14, **Wis** 18, **Cha** 17
**BAB** +12; **CMB** +20; **CMD** 32
**Feats** Cleave, Dodge, Improved Initiative, Multiweapon Fighting, Power Attack, Weapon Focus (greatsword)
**Skills** Acrobatics +13, Bluff +18, Escape Artist +22, Intimidate +18, Knowledge (planes) +14, Knowledge (religion) +14, Perception +23, Sense Motive +19, Stealth +9
**Languages** Common, Infernal; telepathy 100 ft.

**SPECIAL ABILITIES**
**All-Around Vision (Ex):** A khalahathi's two faces grant it the ability to see in all directions simultaneously. It cannot be flanked.
**Multiweapon Mastery (Ex):** A khalahathi takes no penalties on attack rolls when fighting with four weapons. It uses its full Strength bonus on damage rolls with all weapons.
**Whirlwind of Steel (Ex):** Once per round as a full-round action, a khalahathi can make a single attack with each of its four weapons against every creature within its reach. Each attack uses the khalahathi's highest attack bonus. The khalahathi cannot move before or after using this ability.

**ECOLOGY**
**Environment** any (Hell or Nine Worlds)
**Organization** solitary or pair
**Treasure** double (2 masterwork greatswords, 2 masterwork greataxes, other treasure)
...
**XP** 25,600
LE Huge outsider (asura, evil, extraplanar, lawful)
**Init** +4; **Senses** darkvision 60 ft., *detect good*, *detect magic*; **Perception** +26

**DEFENSE**
**AC** 28, touch 8, flat-footed 28 (+20 natural, –2 size)
**hp** 184 (16d10+96); regeneration 10 (good weapons, good spells)
**Fort** +16, **Ref** +5, **Will** +14; +2 vs. enchantments
**DR** 10/good; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 24

**OFFENSE**
**Speed** 40 ft.
**Melee** 2 slams +24 (2d8+10), gore +24 (2d6+10 plus divine disruption), bite +19 (1d8+5)
**Space** 15 ft.; **Reach** 15 ft.
**Special Attacks** divine disruption, trample (2d8+15, DC 28)
**Spell-Like Abilities** (CL 13th; concentration +17)
Constant — *detect good*, *detect magic*
At will — *greater teleport* (self plus 50 lbs. of objects only)
3/day — *dispel magic* (CL 15th), *shatter* (DC 16), *unhallow*
1/day — *antimagic field* (10-ft. radius centered on crest, suppresses divine magic only; see selective antimagic), summon (level 7, 1 khalahathi or 1d3 mautchidaya 50%)

**STATISTICS**
**Str** 30, **Dex** 10, **Con** 22, **Int** 17, **Wis** 18, **Cha** 19
**BAB** +16; **CMB** +28 (+30 bull rush, +30 overrun); **CMD** 38 (42 vs. bull rush, 50 vs. trip)
**Feats** Awesome Blow, Cleave, Great Cleave, Improved Bull Rush, Improved Initiative, Improved Overrun, Power Attack, Weapon Focus (gore)
**Skills** Bluff +20, Escape Artist +22, Intimidate +23, Knowledge (arcana) +19, Knowledge (planes) +19, Knowledge (religion) +22, Perception +26, Sense Motive +23, Spellcraft +22, Survival +17
**Languages** Common, Infernal, Celestial; telepathy 100 ft.

**SPECIAL ABILITIES**
**Divine Disruption (Su):** A tkamaarana's arrowhead bone crest resonates with a frequency that unravels divine magic. Whenever the tkamaarana strikes a creature, object, or area with its gore attack, it functions as a targeted *dispel magic* (CL 13th) against a single divine spell effect of the tkamaarana's choice affecting the target. This affects spells such as *consecrate*, *hallow*, *magic circle against evil*, *shield of faith*, wardstone enchantments, and similar protective divine magic. The tkamaarana can sense divine magical auras within 60 ft. and unerringly identifies the strongest divine effect on any target it can see (as *arcane sight* but for divine magic only).
**Selective Antimagic (Su):** Once per day, a tkamaarana can activate the bone crest to generate a 10-ft.-radius antimagic field centered on its head. This field suppresses only divine spells and spell-like abilities — arcane and psychic magic functions normally within it. The field lasts for 10 rounds and moves with the tkamaarana.
**Siege Body (Ex):** A tkamaarana's natural attacks deal double damage to objects and structures. It ignores hardness of 15 or less.

**ECOLOGY**
**Environment** any (Hell or Nine Worlds)
**Organization** solitary or siege pair
**Treasure** standard

---

### Ramjagodar
*CR 16 — Medium — "Nightlord"*

The most dangerous asura type below the asurendra. A ramjagodar is partially incorporeal — only its eyeless, elongated face and its withered, exposed heart are fully visible, connected by trailing wisps of black smoke that suggest a humanoid form without committing to one. It is a powerful spellcaster and force multiplier that links itself to subordinate asuras to enhance their combat effectiveness. The tactical puzzle it presents is significant: while linked, its subordinates are considerably more dangerous, but killing the ramjagodar triggers a devastating psychic backlash that punishes anyone nearby — especially the linked asuras themselves. Wise commanders clear the subordinates first; desperate ones rush the nightlord and endure the consequences.

**Ramjagodar — CR 16**
**XP** 76,800
LE Medium outsider (asura, evil, extraplanar, lawful)
**Init** +8; **Senses** darkvision 120 ft., *true seeing*, *detect good*; **Perception** +30

**DEFENSE**
**AC** 31, touch 19, flat-footed 22 (+4 deflection, +8 Dex, +1 dodge, +8 natural)
**hp** 230 (20d10+120); regeneration 10 (good weapons, good spells)
**Fort** +12, **Ref** +20, **Will** +18; +2 vs. enchantments
**Defensive Abilities** partial incorporeality; **DR** 10/good and cold iron; **Immune** curse effects, disease, poison; **Resist** acid 10, electricity 10; **SR** 27

**OFFENSE**
**Speed** 30 ft., fly 60 ft. (perfect)
**Melee** incorporeal touch +28 (4d6 negative energy plus 1d4 Wisdom drain)
**Special Attacks** asura link, psychic backlash
**Spell-Like Abilities** (CL 16th; concentration +23)
Constant — *detect good*, *true seeing*
At will — *greater teleport* (self plus 50 lbs. of objects only), *enervation*, *suggestion* (DC 20)
3/day — *dominate person* (DC 22), *feeblemind* (DC 22), *greater dispel magic*, *mass hold person* (DC 24)
1/day — *mass suggestion* (DC 23), *power word stun*, summon (level 8, 1 khalahathi or 1d3 mautchidaya 65%)

**STATISTICS**
**Str** 14, **Dex** 26, **Con** 22, **Int** 23, **Wis** 22, **Cha** 24
**BAB** +20; **CMB** +22; **CMD** 45
**Feats** Ability Focus (psychic backlash), Combat Casting, Dodge, Improved Initiative, Iron Will, Mobility, Quicken Spell-Like Ability (*enervation*), Spell Focus (enchantment), Spring Attack, Weapon Finesse
**Skills** Bluff +30, Diplomacy +27, Escape Artist +37, Fly +39, Intimidate +27, Knowledge (arcana) +26, Knowledge (planes) +29, Knowledge (religion) +26, Perception +30, Sense Motive +29, Spellcraft +29, Stealth +28
**Languages** Common, Infernal, Celestial, Abyssal; telepathy 100 ft.

**SPECIAL ABILITIES**
**Partial Incorporeality (Su):** A ramjagodar exists partly in the material and partly in the ethereal plane simultaneously. It has a 50% miss chance against all attacks except force effects, ghost touch weapons, and attacks that affect both corporeal and incorporeal creatures. Despite this, it can interact with the physical world normally (picking up objects, manipulating terrain, etc.). A *dimensional anchor* or *force cage* suppresses this ability for the spell's duration.
**Asura Link (Su):** As a standard action, a ramjagodar can establish a telepathic link with up to six willing asuras within 120 ft. Linked asuras gain the following benefits: +2 profane bonus to AC, +2 profane bonus on attack rolls and saves, fast healing 5 (or their existing fast healing/regeneration increases by 5), and the ability to communicate telepathically with the ramjagodar regardless of distance (but within the same plane). The link persists until the ramjagodar dismisses it (free action), the linked asura moves to a different plane, or the ramjagodar dies. The ramjagodar can perceive through any linked asura's senses as a swift action.
**Psychic Backlash (Su):** When a ramjagodar is slain, it releases a 60-ft. burst of psychic energy. All creatures within the area must succeed at a Will save (DC 29) or take 10d6 psychic damage and be affected by *confusion* for 1d6 rounds. A successful save halves the damage and negates the confusion. Asuras currently linked to the ramjagodar via asura link take a –4 penalty on this save. The save DC is Charisma-based and includes a +2 bonus from Ability Focus.
**Wisdom Drain (Su):** A creature struck by the ramjagodar's incorporeal touch must succeed at a Will save (DC 27) or take 1d4 points of Wisdom drain. The ramjagodar heals 5 hit points for each point of Wisdom drained. The save DC is Charisma-based.
